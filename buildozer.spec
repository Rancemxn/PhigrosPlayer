...
# (str) Package name
package.name = PhigrosPlayer

# (str) Package domain (needed for android/ios packaging)
package.domain = org.qaqFei.PhigrosPlayer
...
source.exclude_dirs = src/__pycache__
...
requirements = python3,hostpython3,bottle,proxy-tools,typing_extensions,cryptography,requests,PyYAML,numpy==2.0.2,pyjnius,kivy,websockets==13.1,rjsmin,Pillow,opencv,libogg,libvorbis,librosa==0.10.2.post1,fsb5,pydub,UnityPy==1.10.18,android
...
#android.extra_manifest_application_arguments = Extra.xml
